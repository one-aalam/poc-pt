function create(__helpers) {
  ...
  return function render(data, out) {
    ...
    out.w('<div data-module="my-module"><button id="btnLoadAsync" data-type="submit-btn">Load Asynchronously!</button></div><script type="text/javascript" src="scripts/vendors.js"></script><script type="text/javascript" src="scripts/app.js"></script></body></html>');
  };
}
